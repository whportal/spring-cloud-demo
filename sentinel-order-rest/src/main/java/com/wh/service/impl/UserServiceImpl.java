...
public class UserServiceImpl implements UserService {
    ...
    @SentinelResource(value = "UserService#getProductById",
    ...
    public Product getProductById(Long id) {
        String response = restTemplate.getForObject("http://sentinel-product-rest/product-server/product/" + id, String.class);
    ...
    public String getBalanceProduct() {
        String response = restTemplate.getForObject("http://sentinel-product-rest/product-server/product/balance", String.class);
        if (Objects.nonNull(response)) {

...
public class ProductServiceImpl implements ProductService {
    ...
    @SentinelResource(value = "ProductService#getUserById")
    @Override
    public User getUserById(Long id) {
        String response = restTemplate.getForObject("http://sentinel-order-rest/order-server/order/user/" + id, String.class);
    ...
    public String getBalanceOrder() {
        String response = restTemplate.getForObject("http://sentinel-order-rest/order-server/order/balance", String.class);
        if (Objects.nonNull(response)) {
            Gson gson = new Gson();
